...
export class ApiService {
  ...
  getAllHotelDetails() { 
    return this.httpService.get('api/get-hotel-details');
  }

  getHotelsList(){
    return this.httpService.get('api/get-hotel-list');
  }

  getAllAmenities(){
    return this.httpService.get('api/get-amenities');
  }
  
  getRoomAmenity(){
    return this.httpService.get('api/get-room-amenities');
  }

  getFAQ(){
    return this.httpService.get('api/get-faq');
  }
